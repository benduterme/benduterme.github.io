...
var DATA = {
  ...
  articles: [{
    ...
    prix: {},
    articles: [{ id: "confiseries-1", nom: "Orangettes - 180 g", img: "./src/img/Cadeaux/Orangettes.jpg", choix: [{ value: 6., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-2", nom: "Cerisettes - 180 g", img: "./src/img/Pralibel/confiseries/cerisette.png", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-3", nom: "Mendiants - 180 g", img: "./src/img/Cadeaux/Mendiants.jpg", choix: [{ value: 6., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-4", nom: "Gianduja - 180 g", img: "./src/img/Cadeaux/Gianduja.png", choix: [{ value: 6., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-5", nom: "Liqueurs - 180 g", img: "./src/img/Cadeaux/liqueurs.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-6", nom: "Truffes - 250 g", img: "./src/img/Cadeaux/Truffes.jpg", choix: [{ value: 6., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-7", nom: "Pâtes de fruits - 180 g", img: "./src/img/Cadeaux/Pâtes de Fruits.jpg", choix: [{ value: 6., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-8", nom: "Pralines sans sucre - 250 g", img: "./src/img/Cadeaux/Stevia.jpg", choix: [{ value: 9., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-9", nom: "Florentines - ± 10 pcs", img: "./src/img/Cadeaux/florentines.jpg", choix: [{ value: 6., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-10", nom: "Palets de chocolat - 17 pcs", img: "./src/img/Cadeaux/palets-chocolat.png", choix: [{ value: 6., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-11", nom: "Assortiment - 24 mini tablettes", img: "./src/img/Cadeaux/assortiment-noël.png", choix: [{ value: 17., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-12", nom: "Nougats - 150 g", img: "./src/img/Cadeaux/nougats.PNG", choix: [{ value: 6.6, count: 0, type: "euros", poids: 0.15 }] }]
  }]
};
...
function shop() {
  ...
  return {
    ...
    sendEmail: function sendEmail() {
      ...
      var message3 = "Madame, Monsieur,<br><br>" + "Merci pour votre commande chez La Gourmandise.<br>" + "Nous vous remercions pour votre confiance et mettrons tout en oeuvre pour qu'elle r\xE9ponde \xE0 vos attentes.<br>";
      ...
      message3 += "Date d'enl\xE8vement: " + this.user.date + "<br><br>";
      ...
      var message4 = "Cher client,<br><br>" + "Nous avons le plaisir de vous annoncer que votre commande est pr\xEAte et disponible dans votre magasin.<br><br>" + "Nous vous invitons \xE0 venir la r\xE9cup\xE9rer durant les heures d'ouverture de celui-ci, \xE0 savoir du mardi au dimanche, de 10 h 00 \xE0 12 h 00 et de 13 h 30 \xE0 18 h 00.<br><br>" + "Merci pour votre confiance et nous esp\xE9rons que vous serez enti\xE8rement satisfaits par nos chocolats.<br><br>" + "<img src=\"https://www.lagourmandisebouillon.be/src/img/gourmandise-logo.PNG\" alt=\"La Gourmandise Bouillon\">";
