...
var DATA = {
  ...
  articles: [{
    ...
    prix: {},
    articles: [{ id: "confiseries-1", nom: "Orangettes - 180 g", img: "./src/img/Cadeaux/Orangettes.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-2", nom: "Cerisettes - 180 g", img: "./src/img/Pralibel/confiseries/cerisette.png", choix: [{ value: 8., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-3", nom: "Mendiants - 180 g", img: "./src/img/Cadeaux/Mendiants.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-4", nom: "Gianduja - 180 g", img: "./src/img/Cadeaux/Gianduja.png", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-5", nom: "Liqueurs - 180 g", img: "./src/img/Cadeaux/liqueurs.jpg", choix: [{ value: 8., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-6", nom: "Truffes - 250 g", img: "./src/img/Cadeaux/Truffes.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-7", nom: "Pâtes de fruits - 180 g", img: "./src/img/Cadeaux/Pâtes de Fruits.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.18 }] }, { id: "confiseries-8", nom: "Pralines sans sucre - 250 g", img: "./src/img/Cadeaux/Stevia.jpg", choix: [{ value: 10., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-9", nom: "Florentines - ± 10 pcs", img: "./src/img/Cadeaux/florentines.jpg", choix: [{ value: 7., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-10", nom: "Palets de chocolat - 17 pcs", img: "./src/img/Cadeaux/palets-chocolat.png", choix: [{ value: 7., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-11", nom: "Assortiment - 24 mini tablettes", img: "./src/img/Cadeaux/assortiment-noël.png", choix: [{ value: 18., count: 0, type: "euros", poids: 0.25 }] }, { id: "confiseries-12", nom: "Nougats - 150 g", img: "./src/img/Cadeaux/nougats.PNG", choix: [{ value: 7.6, count: 0, type: "euros", poids: 0.15 }] }]
  }]
};
